...
const UserManagement = () => {
  ...
  const handleRoleChange = (userId,newRole:string) =>{
    console.log({id:userId , role:newRole})
  }

  const handleDeleteUser= (userId) =>{
    if(window.confirm("Are you sure you want to delete this account")) {
      console.log("Deeting user with ID ",userId)
    }
  }
    ...
    <div className='text-left max-w-7xl mx-auto p-6'>
        ...
        <div className='p-6 rounded-lg mb-6'>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className='bg-green-600 text-white py-2 px-4 rounded hover:bg-green-700'>Add User</button>
            </form>
        </div>
