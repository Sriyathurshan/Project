                            ...
                            <tr key={product._id} className='border-b hover:bg-gray-50 cursor-pointer'>
                               ...
                               <td className='p-6'>
                                    <Link to={`/admin/products/${product._id}/edit`} 
                                        className='bg-yellow-500  text-white px-4 py-3 rounded mr-2 hover:bg-yellow-600'>Edit</Link>
                                    <button onClick={() => handleDelete(product._id)}
                                        className='bg-red-500  text-white px-2 py-1 rounded hover:bg-red-600 hover:text-black'>Delete</button>
                               </td>
                            </tr>
