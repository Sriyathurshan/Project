...
const EditProductPage = () => {
  ...
  return (
    <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md text-left'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <button type='submit' className=' text-white w-full bg-green-600 hover:bg-green-700 transition-colors'>Update Product</button>
        </form>
    </div>
  )
}
